...
const translations = {
    ja: {
        ...
        'dashboard.noRoundsYet': 'まだラウンドがありません。ToNStatToolでプレイを開始してください。',
        ...
        'settings.apiKeysDesc': 'との連携に使用するAPIキーを作成します。',
        ...
        'settings.noPlayerProfilePre': 'プレイヤープロフィールがまだありません。',
        'settings.noPlayerProfilePost': 'でラウンドデータを送信すると自動的に作成されます。',
        ...
        'myHistory.noProfile': 'プレイヤープロフィールがまだありません。ToNStatToolでラウンドをプレイして作成してください！',
        'myHistory.noProfileHint': 'ToNStatToolがVRChat名でプレイヤーデータを送信していることを確認してください。',
        ...
        'globalStats.participations': '参加回数',
    ...
    en: {
        ...
        'dashboard.noRoundsYet': 'No rounds yet. Start playing with ToNStatTool!',
        ...
        'settings.apiKeysDesc': ' integration API keys.',
        ...
        'settings.step3': ' and go to Settings',
        ...
        'settings.noPlayerProfilePre': 'No player profile yet. ',
        'settings.noPlayerProfilePost': ' to send round data and create one.',
        ...
        'myHistory.noProfile': "You don't have a player profile yet. Play some rounds with ToNStatTool to create one!",
        'myHistory.noProfileHint': 'Make sure ToNStatTool is sending player data with your VRChat name.',
        ...
        'globalStats.participations': 'Participations',
        ...
        'globalStats.holdRate': 'Hold Rate',
